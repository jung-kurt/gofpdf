...
gofpdf will be available automatically when you build your application.
If you want to view or modify the source tree, execute the following in
a directory that is outside of your $GOPATH.
...
for imported objects and templates.
